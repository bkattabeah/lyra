...
pipgit
# Install Mamba environment setup for inference with
```bash
CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python scripts/test_environment.py
```

> **Note (personal):** The Apex build step is the slowest part of setup and can take 20–30 minutes depending on your GPU/CPU. Grab a coffee.
